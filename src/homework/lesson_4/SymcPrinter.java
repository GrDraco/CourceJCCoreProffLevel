...
class SyncPrinter extends Thread {
    ...
    public static void startPrint(int countRepeat, char... charsToPrint) {
        ...
        for(char ch: charsToPrint) {
            ...
            new SyncPrinter(ch, charsToPrint[next], countRepeat).start();
        }
    }
    ...
    public SyncPrinter(char charPrint, char charNextPrint, int countRepeat) {
